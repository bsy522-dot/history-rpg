...
## [AUTO] 2026-06-13 history-rpg — v16.0 왕실조정12관직+고대문자해독6종+민생경제시뮬+전장보고서레이더Canvas+유적발굴8곳+역사시나리오6종+군사훈련소6종+세력연대기Canvas+15퀴즈추가(120→135)+12업적추가(72→84)+SFX10종+키보드8종

### 1차: 벤치마킹 분석

| 경쟁앱 | 열위점 | 해결 |
|--------|--------|------|
| 영걸전 | 조정/관직 시스템 부재 | 왕실 조정 12관직 시스템 |
| 영걸전 | 유적 발굴/고고학 콘텐츠 없음 | 유적 발굴 8곳 |
| 영걸전 | 역사 분기 시나리오 없음 | 역사 시나리오 6종 |
| 영걸전 | 군사 훈련/유닛 성장 체계 미흡 | 군사 훈련소 6종 |
| 문명 | 민생 경제 시뮬레이션 부재 | 민생 경제 (인구/세금/행복도/반란) |
| 문명 | 전투 결과 통계 분석 없음 | 전장 보고서 레이더 Canvas |
| 문명/AOE | 세력 흥망 시각화 부재 | 세력 연대기 Canvas 그래프 |
| AOE | 고대 문자/문화 콘텐츠 부족 | 고대 문자 해독 6종 Canvas |

### 2차: 개발 내역

**v16_patch.js** (901줄 ~55KB, 자기완결형 IIFE 패치 모듈)

1. **왕실 조정 시스템**: 12관직 (상대등/대장군/국상/첩보수장/사도/좌보/천군/장작감/행인/박사/비장/조의) + 12캐릭터 임명/해임 + 충성도 + 조정 기록
2. **고대 문자 해독**: Canvas 400x180 고대 문자 렌더링 + 6퍼즐 (천부인/홍익인간/아사달/단군왕검/팔조금법/영고) + 4지선다 + 해독 진행률
3. **민생 경제**: 인구/세율/행복도/식량/반란위험 5지표 + 6정책 (잔치/이주민/세율조정/농경/진압) + 턴 진행 + 인구 성장/반란 시뮬
4. **전장 보고서**: Canvas 360x360 6축 레이더 차트 (공격력/방어력/전술/지휘력/사기/지구력) + 6통계 카드 (승리/패배/격파/피해/치유/턴)
5. **유적 발굴**: 8유적지 (고조선왕궁터/고인돌/청동기제작소/소도/철광산/부여왕릉/삼한마을/왕검성) + 깊이층 + 발굴 진행률 + 유물 보상
6. **역사 시나리오**: 6분기 (환웅하강/곰호랑이시험/수도선정/청동철기전환/한나라외교/왕위계승) + 2선택지 + 결과 피드백
7. **군사 훈련소**: 6종 (궁술/검술/진형/기마/공성/잠입) Lv.1~10 성장 + 누적 XP + 프로그레스바
8. **세력 연대기**: Canvas 520x300 꺾은선 그래프 + 고조선/부여/삼한 3세력 BC2333~BC18 12시점 흥망

**추가:**
- 퀴즈 +15문 (120→135): 홍익인간/천부인/8조법/영고/소도/왕검성/위만/비파형동검/지석묘/변한/무천/민며느리제/소/노비/풍백우사운사
- 업적 +12개 (72→84): court_first/court_full/decode_first/decode_master/civlife_action/civlife_prosper/report_view/excav_first/excav_master/scenario_first/scenario_master/academy_first
- SFX 10종: court_assign/court_event/decode_correct/decode_wrong/civlife_action/report_open/excav_dig/excav_find/scenario_choose/academy_train
- 키보드 단축키 +8종 (Shift+Q/O/L/B/X/H/N/F)
- 퀵 액션 버튼 8종 자동 삽입

**파일 변경:**
- js/v16_patch.js: 신규 (901줄)
- sw.js: v15→v16 (krpg-v16 캐시, v16_patch.js PRECACHE+자동주입)
- index.html: v16.0 SEO 전면 갱신 (title/desc/keywords/OG/Twitter/JSON-LD) + v16 신기능배지8종 + 84업적
- korean-rpg-v7.html: v16.0 (title/desc/keywords)
- manifest.json: v16.0 설명+shortcuts 조정/발굴/시나리오/훈련소
...
|------|------|
| JS 문법 (node -c) | PASS |
| 괄호 밸런스 () | 615/615 BALANCED |
| 괄호 밸런스 {} | 388/388 BALANCED |
| 괄호 밸런스 [] | 103/103 BALANCED |
| HTML div (index.html) | 19/19 BALANCED |
| HTML div (korean-rpg-v7.html) | 105/105 BALANCED |
| 외부 CDN | 0건 (PASS) |
| 개인정보 노출 | 0건 (PASS) |
