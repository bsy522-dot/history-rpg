...
## [AUTO] 2026-06-29 history-rpg v19.0

### 1단계: 벤치마킹
| 비교 대상 | 핵심 강점 | 도입 아이디어 |
|-----------|-----------|---------------|
| 영걸전 시리즈 | 천문·점성 시스템, 무장 상세 도감 | 고대 천문관(28수 별자리 Canvas), 무장 갤러리(16종 상세 스탯) |
| 문명 시리즈 | 외교 시스템, 민심·행복도, 불가사의 연대기 | 외교 회담장(5국 Canvas), 민심 게이지(6축 레이더 Canvas) |
| 에이지 오브 엠파이어 | 전쟁 타임라인, 전략 보드게임, 군악 | 전쟁 연대기(16건 Canvas), 전략 보드게임(8x8), 고대 음악 연주기(8곡) |

### 2단계: 개발 내역

#### v19_patch.js 신규 8대 기능
| # | 기능 | 설명 | 키보드 |
|---|------|------|--------|
| 1 | 고대 천문관 | 28수 별자리 Canvas 인터랙티브 성도, 동서남북 7수씩 색상 구분 | Shift+Q |
| 2 | 전쟁 연대기 | 고조선~삼한 16건 주요 전쟁 타임라인 Canvas, 시대별 색상 | Shift+R |
| 3 | 외교 회담장 | 5국(고조선/연/한/흉노/예맥) 관계 Canvas, 동맹·전쟁·조공 관리 | Shift+S |
| 4 | 고대 암호 해독기 | 치환/시저/레일펜스 등 6종 암호 해독 미니게임 | Shift+U |
| 5 | 무장 갤러리 | 검/창/궁 등 16종 고대 무기 상세 스탯 카탈로그 | Shift+V |
| 6 | 민심 게이지 | 6축(군사·경제·문화·외교·민생·종교) 레이더 차트 Canvas | Shift+W |
| 7 | 전략 보드게임 | 8x8 격자 턴제 전략 보드게임 Canvas, AI 대전 | Shift+X |
| 8 | 고대 음악 연주기 | 8곡 고대 음악 Web Audio API 재생기 | Shift+Y |
...
| SFX | +12 | 12종 (v19) |
| 키보드 단축키 | +8 | 8종 (v19) |
| 하단 네비게이션 버튼 | +8 | 8종 (v19) |

#### 파일 변경 목록
| 파일 | 변경 내용 |
|------|-----------|
| js/v19_patch.js | 신규 — 8대 기능 IIFE, 15퀴즈, 12업적, 12SFX, 8키보드, 8네비 |
| korean-rpg-v7.html | v19 script 태그 추가, title-sub v19.0 갱신 |
| index.html | v19 SEO 메타 전체 갱신, 기능 배지 8종, 180퀴즈/120업적 |
| sw.js | CACHE krpg-v19, PRECACHE v19_patch.js 추가, 인젝션 배열 v19 추가 |
| manifest.json | description v19.0, 9개 신규 shortcuts 추가 |

### 3단계: 품질 검증
| 검증 항목 | 결과 |
|-----------|------|
| JS 문법 검사 (node -c) | ✅ v19_patch.js, sw.js 통과 |
| 외부 CDN 참조 | ✅ 0건 |
| 개인정보 노출 | ✅ 0건 |
| SW 캐시 갱신 | ✅ krpg-v19 |
| Manifest 갱신 | ✅ v19.0 + 15 shortcuts |
