const CACHE='krpg-v15';
const PRECACHE=[
  './index.html','./korean-rpg-v7.html','./manifest.json',
  './js/config.js','./js/audio.js','./js/story.js','./js/engine.js',
  './js/battle.js','./js/minigames.js','./js/ui.js','./js/v10_patch.js','./js/v11_patch.js','./js/v12_patch.js','./js/v13_patch.js','./js/v14_patch.js','./js/v15_patch.js'
];
      ...
      fetch(e.request).then(r=>{
        if(r.ok&&isGame){
          return r.text().then(html=>{
            ['v10','v11','v12','v13','v14','v15'].forEach(v=>{
